...
import kotlinx.android.synthetic.main.activity_most_item_selling.*

class MostItemSelling : AppCompatActivity() {
    var db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_most_item_selling)
    ...
    private fun productData(){
        ...
        db.collection("item").whereGreaterThanOrEqualTo("itemCounter",1 )
            .orderBy("itemCounter", Query.Direction.DESCENDING)
            .get()
